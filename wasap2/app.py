...
import json
wallpaper = 'assets/icons/piolin.jpeg'
w= 1000
h=800
m1 = 50
m2 = 270
...
class App(UserControl):
  ...
  #definimos la funcion enviar mensajes
  def enviar_mensaje(self,e):
    mensaje_texto = input_mensaje.value  # Obtener el texto del campo de texto
    if mensaje_texto:
      self.agregar_nuevo_mensaje(self, mensaje_texto)
      input_mensaje.value = ""  # Limpiar el campo de texto después de enviar el mensaje
